...
function BootstrapPage() {
  ...
  return (
    <div className="bootstrap-container">
      <div className="m-4 mx-auto flex flex-col items-center overflow-hidden rounded-lg border border-gray-300 bg-white text-center shadow-md">
        ...
        {showForm ? (
          <>
            ...
            <ul className="w-[calc(100%-2rem)] rounded-md border border-gray-200 bg-white text-left  text-black">
              ...
              {system_id.length < 2 && space_list.length === 0 && (
