      ...
      <div className="flex items-center justify-end gap-3">
        {active && (
          <button
            ...
            className={`btn-primary btn-ghost flex flex-col justify-center items-center w-20 h-20 ${modalType == "survey" ? "btn-active rounded-2xl bg-blue-600! text-white" : "bg-avit-grey!"}`}
          >
            <Icon
        ...
        {active && (
          <button
            ...
            className={`btn-primary flex flex-col justify-center items-center w-20 h-20 ${modalType == "none" ? "btn-active rounded-2xl bg-blue-600! text-white text-white" : "bg-avit-grey!"}`}
          >
            <Icon
        ...
        {active && (
          <button
            ...
            className={`btn-primary flex flex-col justify-center items-center w-20 h-20 ${modalType == "tour" ? "btn-active rounded-2xl bg-blue-600! text-white" : "bg-avit-grey!"}`}
          >
            <Icon
        ...
        <button
          ...
          className={`btn-primary flex flex-col justify-center items-center w-20 h-20 ${modalType == "support" ? "btn-active rounded-2xl bg-blue-600! text-white" : "bg-avit-grey!"}`}
        >
        ...
        {active && (
          <button
            ...
            className={`btn-primary btn-ghost flex flex-col justify-center items-center w-20 h-20 ${modalType == "settings" ? "btn-active rounded-2xl bg-blue-600! text-white" : "bg-avit-grey!"}`}
          >
        ...
        {active && (
          <button
            ...
            className={`btn-primary btn-ghost flex flex-col justify-center items-center w-20 h-20 ${modalType == "shutdown" ? "btn-active rounded-2xl bg-blue-600! text-white" : "bg-avit-grey!"}`}
          >
            <Icon
