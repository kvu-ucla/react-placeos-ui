...
export default function SettingsModal({
  ...
  const isKiosk = window.innerWidth === 1280 && window.innerHeight === 800;
  const modalClass = isKiosk
      ? "modal-box bg-white p-6 w-[90vw] h-[85vh] max-w-full rounded-lg overflow-y-auto"
      : "modal-box bg-white p-8 w-[1547px] h-[1098px] max-w-full rounded-lg";
