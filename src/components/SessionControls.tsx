...
function ControlCard({
  ...
  return (
    <button
      ...
      id={id}
      className={`w-full h-full btn-primary active:bg-gray-100 p-0 border-none rounded-[10px] transition-colors text-white ${buttonState ? 'bg-white border-white' : 'bg-avit-blue active:bg-[#011c50]'}`}
    >
